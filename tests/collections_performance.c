...
test_alist_performance(int sizes[])
{
    ...
    for (int i = 0; sizes[i] != 0; i++)
    {
        ...
        end_ms = cra_monotonic_ms();
        printf("\tremove random: %" PRIu64 "ms.\n", end_ms - start_ms);
    }
