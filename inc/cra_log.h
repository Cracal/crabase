...
#define cra_log_message(_logname, _level, _fmt, ...) __cra_log_message(_logname, _level, _fmt, ##__VA_ARGS__)
#endif
...
#define cra_log_trace(_fmt, ...) cra_log_trace_with_logname(CRA_LOG_NAME, _fmt, ##__VA_ARGS__)
#define cra_log_debug(_fmt, ...) cra_log_debug_with_logname(CRA_LOG_NAME, _fmt, ##__VA_ARGS__)
#define cra_log_info(_fmt, ...)  cra_log_info_with_logname(CRA_LOG_NAME, _fmt, ##__VA_ARGS__)
#define cra_log_warn(_fmt, ...)  cra_log_warn_with_logname(CRA_LOG_NAME, _fmt, ##__VA_ARGS__)
#define cra_log_error(_fmt, ...) cra_log_error_with_logname(CRA_LOG_NAME, _fmt, ##__VA_ARGS__)
#define cra_log_fatal(_fmt, ...) cra_log_fatal_with_logname(CRA_LOG_NAME, _fmt, ##__VA_ARGS__)
