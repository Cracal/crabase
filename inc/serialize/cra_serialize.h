...
#define __CRA_TYPE_META_NUMBER(_TYPE, _size) \
    {_TYPE, false, _size, 0, 0, 0, NULL, NULL, NULL, NULL, NULL},
#define CRA_TYPE_META_BOOL() \
    __CRA_TYPE_META_NUMBER(CRA_TYPE_FALSE, sizeof(bool))
#define CRA_TYPE_META_INT8() \
    __CRA_TYPE_META_NUMBER(CRA_TYPE_INT8, sizeof(int8_t))
#define CRA_TYPE_META_INT16() \
    __CRA_TYPE_META_NUMBER(CRA_TYPE_INT16, sizeof(int16_t))
#define CRA_TYPE_META_INT32() \
    __CRA_TYPE_META_NUMBER(CRA_TYPE_INT32, sizeof(int32_t))
#define CRA_TYPE_META_INT64() \
    __CRA_TYPE_META_NUMBER(CRA_TYPE_INT64, sizeof(int64_t))
#define CRA_TYPE_META_UINT8() \
    __CRA_TYPE_META_NUMBER(CRA_TYPE_UINT8, sizeof(uint8_t))
#define CRA_TYPE_META_UINT16() \
    __CRA_TYPE_META_NUMBER(CRA_TYPE_UINT16, sizeof(uint16_t))
#define CRA_TYPE_META_UINT32() \
    __CRA_TYPE_META_NUMBER(CRA_TYPE_UINT32, sizeof(uint32_t))
#define CRA_TYPE_META_UINT64() \
    __CRA_TYPE_META_NUMBER(CRA_TYPE_UINT64, sizeof(uint64_t))
#define CRA_TYPE_META_FLOAT() \
    __CRA_TYPE_META_NUMBER(CRA_TYPE_FLOAT, sizeof(float))
#define CRA_TYPE_META_DOUBLE() \
    __CRA_TYPE_META_NUMBER(CRA_TYPE_DOUBLE, sizeof(double))
// `_is_char_ptr`: is cahr pointer, not char array. `true`: char *; `false`: char[N];
#define CRA_TYPE_META_STRING(_length, _is_char_ptr) \
...
#define CRA_TYPE_META_STRUCT(_size, _is_ptr, _members_meta, _init_i, _args4init) \
...
#define CRA_TYPE_META_LIST(_size, _is_ptr, _element_meta, _iter_i, _init_i, _args4init) \
...
#define CRA_TYPE_META_ARRAY(_size, _is_ptr, _element_meta) \
...
#define CRA_TYPE_META_DICT(_size, _is_ptr, _kv_meta, _iter_i, _init_i, _args4init) \
    {CRA_TYPE_DICT, _is_ptr, _size, 0, 0, 0, NULL, _kv_meta, _iter_i, _init_i, _args4init},

#define __CRA_TYPE_META_MEMBER_NUMBER(_Type, _TYPE, _member) \
    {_TYPE, false, __CRA_SIZEOF_0(_Type, _member), offsetof(_Type, _member), 0, 0, #_member, NULL, NULL, NULL, NULL},
#define CRA_TYPE_META_MEMBER_BOOL(_Type, _member) \
    __CRA_TYPE_META_MEMBER_NUMBER(_Type, CRA_TYPE_FALSE, _member)
#define CRA_TYPE_META_MEMBER_INT8(_Type, _member) \
    __CRA_TYPE_META_MEMBER_NUMBER(_Type, CRA_TYPE_INT8, _member)
#define CRA_TYPE_META_MEMBER_INT16(_Type, _member) \
    __CRA_TYPE_META_MEMBER_NUMBER(_Type, CRA_TYPE_INT16, _member)
#define CRA_TYPE_META_MEMBER_INT32(_Type, _member) \
    __CRA_TYPE_META_MEMBER_NUMBER(_Type, CRA_TYPE_INT32, _member)
#define CRA_TYPE_META_MEMBER_INT64(_Type, _member) \
    __CRA_TYPE_META_MEMBER_NUMBER(_Type, CRA_TYPE_INT64, _member)
#define CRA_TYPE_META_MEMBER_UINT8(_Type, _member) \
    __CRA_TYPE_META_MEMBER_NUMBER(_Type, CRA_TYPE_UINT8, _member)
#define CRA_TYPE_META_MEMBER_UINT16(_Type, _member) \
    __CRA_TYPE_META_MEMBER_NUMBER(_Type, CRA_TYPE_UINT16, _member)
#define CRA_TYPE_META_MEMBER_UINT32(_Type, _member) \
    __CRA_TYPE_META_MEMBER_NUMBER(_Type, CRA_TYPE_UINT32, _member)
#define CRA_TYPE_META_MEMBER_UINT64(_Type, _member) \
    __CRA_TYPE_META_MEMBER_NUMBER(_Type, CRA_TYPE_UINT64, _member)
#define CRA_TYPE_META_MEMBER_FLOAT(_Type, _member) \
    __CRA_TYPE_META_MEMBER_NUMBER(_Type, CRA_TYPE_FLOAT, _member)
#define CRA_TYPE_META_MEMBER_DOUBLE(_Type, _member) \
    __CRA_TYPE_META_MEMBER_NUMBER(_Type, CRA_TYPE_DOUBLE, _member)
// `_is_char_ptr`: is cahr pointer, not char array. `true`: char *; `false`: char[N];
#define CRA_TYPE_META_MEMBER_STRING(_Type, _member, _is_char_ptr)                                                \
...
// `is_ptr`: is not a char array. `true`: char *; `false`: char[N];
#define CRA_TYPE_META_MEMBER_STRING_NZ(_Type, _member, _is_ptr)                                  \
    {CRA_TYPE_STRING, _is_ptr, __CRA_SIZEOF_##_is_ptr(_Type, _member), offsetof(_Type, _member), \
     __CRA_SIZEOF_0(_Type, n##_member), offsetof(_Type, n##_member), #_member, NULL, NULL, NULL, NULL},
// `is_ptr`: `true` -> struct X *; `false` -> struct X;
#define CRA_TYPE_META_MEMBER_STRUCT(_Type, _member, _is_ptr, _members_meta, _init_i, _args4init)       \
...
// `is_ptr`: `true` -> ListType *; `false` -> ListType;
#define CRA_TYPE_META_MEMBER_LIST(_Type, _member, _is_ptr, _element_meta, _iter_i, _init_i, _args4init) \
...
#define CRA_TYPE_META_MEMBER_ARRAY(_Type, _member, _is_ptr, _element_meta)                     \
...
// `is_ptr`: `true` -> DictType *; `false` -> DictType;
#define CRA_TYPE_META_MEMBER_DICT(_Type, _member, _is_ptr, _kv_meta, _iter_i, _init_i, _args4init) \
