...
static inline bool cra_thrd_create(cra_thrd_t *th, cra_thrd_start_fn func, void *arg)
{
    return thrd_success == thrd_create(th, func, arg);
}

static inline bool cra_thrd_join(cra_thrd_t th)
{
...
CRA_API cra_tid_t cra_thrd_get_current_tid(void);
